...
public class FindOrganisationsFault extends Exception {
    ...
    public FindOrganisationsFault(String message, fish.focus.wsdl.user.types.UserFault userFault) {
        super(message);
        this.userFault = userFault;
    }

    public FindOrganisationsFault(String message, fish.focus.wsdl.user.types.UserFault userFault, Throwable cause) {
        super(message, cause);
        this.userFault = userFault;
    }
