...
public class UserModuleFaultException extends Exception {
    ...
    private fish.focus.wsdl.user.types.UserFault userFault;
    ...
    public UserModuleFaultException(String message, fish.focus.wsdl.user.types.UserFault userFault) {
        super(message);
        this.userFault = userFault;
    }

    public UserModuleFaultException(String message, fish.focus.wsdl.user.types.UserFault userFault, Throwable cause) {
        super(message, cause);
        this.userFault = userFault;
    }

    public fish.focus.wsdl.user.types.UserFault getFaultInfo() {
